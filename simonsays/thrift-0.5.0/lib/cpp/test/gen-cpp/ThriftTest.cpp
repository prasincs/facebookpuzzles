    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->thing = (Numberz::type)ecast168;
          this->__isset.thing = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (Numberz::type)ecast169;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (Numberz::type)ecast170;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i205 = 0; _i205 < _size201; ++_i205)
            {
              ...
              std::map<Numberz::type, Insanity> & _val207 = this->success[_key206];
              {
                _val207.clear();
                uint32_t _size208;
                ...
                {
                  Numberz::type _key213;
                  int32_t ecast215;
                  xfer += iprot->readI32(ecast215);
                  _key213 = (Numberz::type)ecast215;
...
uint32_t ThriftTest_testInsanity_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_MAP, 0);
    {
      ...
      std::map<UserId, std::map<Numberz::type, Insanity> > ::const_iterator _iter216;
      for (_iter216 = this->success.begin(); _iter216 != this->success.end(); ++_iter216)
      {
        xfer += oprot->writeI64(_iter216->first);
        {
          ...
          std::map<Numberz::type, Insanity> ::const_iterator _iter217;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i222 = 0; _i222 < _size218; ++_i222)
            {
              ...
              std::map<Numberz::type, Insanity> & _val224 = (*(this->success))[_key223];
              {
                _val224.clear();
                uint32_t _size225;
                ...
                {
                  Numberz::type _key230;
                  int32_t ecast232;
                  xfer += iprot->readI32(ecast232);
                  _key230 = (Numberz::type)ecast232;
    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->arg4 = (Numberz::type)ecast240;
...
void ThriftTestProcessor::process_testOneway(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
